...
<body>
	...
	<section id="supporters" class="section-with-bg wow fadeInUp">
		<div class="row no-gutters supporters-wrap clearfix">
			<div class="col-xl-6 screen" id="eo">
				<div class="content">
					<h2 class="text-center"><a href="<?php echo base_url(); ?>home/home">Syncronize <br> Event <br>
							Organizer</h2>
					</a>
				</div>
			</div>
			<div class="col-xl-6 screen" id="dj">
				<div class="content">
					<h2 class="text-center"><a href="<?php echo base_url(); ?>user/talent">Syncronize <br> DJ <br>
							Management</h2>
					</a>
				</div>
			</div>
